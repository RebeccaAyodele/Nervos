 ...
 */
export async function run(preopens_path, args) {
    let stdoutContent = "";
    let stderrContent = "";
    ...
    const wasm_debugger_path = path.join(__dirname, "../src/wasm/ckb-debugger.wasm");
 ...
 */
export async function compileQjsBytecode(jsPath, bcPath) {
