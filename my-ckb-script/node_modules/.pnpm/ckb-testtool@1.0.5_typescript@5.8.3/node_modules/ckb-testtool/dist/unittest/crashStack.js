...
export function printCrashStack(result, verifier) {
    if (result.status == 0) {
...
function findPackageRoot(startDir) {
    ...
    if (!workspaceRoot)
        workspaceRoot = nearestPackageRoot ?? path.resolve(startDir);
    return workspaceRoot;
}
export function toRelFromProject(projectDir, relFromCwd) {
