...
export const CELL_FIELD_OCCUPIED_CAPACITY = bindings.CELL_FIELD_OCCUPIED_CAPACITY;
export const HEADER_FIELD_EPOCH_NUMBER = bindings.HEADER_FIELD_EPOCH_NUMBER;
export const HEADER_FIELD_EPOCH_START_BLOCK_NUMBER = bindings.HEADER_FIELD_EPOCH_START_BLOCK_NUMBER;
 ...
 */
export function loadCell(index, source) {
 ...
 * ```
 */
export function loadInput(index, source) {
 ...
 */
export function loadWitness(index, source) {
 ...
 * potentially causing an out-of-memory error.
 */
export function loadWitnessArgs(index, source) {
    let bytes = bindings.loadWitness(index, source);
 ...
 * @throws Error if there's a system error
 */
export function loadScriptHash() {
 ...
 * ```
 */
export function loadCellCapacity(index, source) {
    let bytes = bindings.loadCellByField(index, source, bindings.CELL_FIELD_CAPACITY);
 ...
 * ```
 */
export function loadCellOccupiedCapacity(index, source) {
    let bytes = bindings.loadCellByField(index, source, bindings.CELL_FIELD_OCCUPIED_CAPACITY);
    return numFromBytes(bytes);
}
/**
 * Load cell data
 ...
 */
export function loadCellData(index, source) {
 ...
 * ```
 */
export function loadCellTypeHash(index, source) {
    try {
        let bytes = bindings.loadCellByField(index, source, bindings.CELL_FIELD_TYPE_HASH);
        return bytes;
    }
    catch (e) {
 ...
 * ```
 */
export function loadCellLock(index, source) {
 ...
 * ```
 */
export function loadCellLockHash(index, source) {
    let bytes = bindings.loadCellByField(index, source, bindings.CELL_FIELD_LOCK_HASH);
    return bytes;
}
/**
 * Load cell type
 ...
 * ```
 */
export function loadCellType(index, source) {
    try {
        let bytes = bindings.loadCellByField(index, source, bindings.CELL_FIELD_TYPE);
        return Script.fromBytes(bytes);
    }
    catch (e) {
        if (e.errorCode === bindings.ITEM_MISSING) {
 ...
 * ```
 */
export function loadHeaderEpochNumber(index, source) {
    let bytes = bindings.loadHeaderByField(index, source, bindings.HEADER_FIELD_EPOCH_NUMBER);
    return numFromBytes(bytes);
}
/**
 ...
 * ```
 */
export function loadHeaderEpochStartBlockNumber(index, source) {
    let bytes = bindings.loadHeaderByField(index, source, bindings.HEADER_FIELD_EPOCH_START_BLOCK_NUMBER);
    return numFromBytes(bytes);
}
/**
 ...
 * ```
 */
export function loadHeaderEpochLength(index, source) {
    let bytes = bindings.loadHeaderByField(index, source, bindings.HEADER_FIELD_EPOCH_LENGTH);
    return numFromBytes(bytes);
}
/**
 * Load header.
 ...
 * ```
 */
export function loadHeader(index, source) {
 ...
 * ```
 */
export function loadInputSince(index, source) {
    let bytes = bindings.loadInputByField(index, source, bindings.INPUT_FIELD_SINCE);
    return numFromBytes(bytes);
}
/**
 ...
 * ```
 */
export function loadInputOutPoint(index, source) {
    let bytes = bindings.loadInputByField(index, source, bindings.INPUT_FIELD_OUT_POINT);
 ...
 */
export function findCellByDataHash(dataHash, source) {
    if (dataHash.byteLength !== 32) {
        throw new Error("dataHash must be 32 bytes");
    }
    for (let i = 0;; i++) {
        try {
            const hash = bindings.loadCellByField(i, source, bindings.CELL_FIELD_DATA_HASH);
 ...
 */
export function lookForDepWithHash2(codeHash, hashType) {
    if (codeHash.byteLength !== 32) {
        throw new Error("codeHash must be 32 bytes");
    }
    const field = hashType === bindings.SCRIPT_HASH_TYPE_TYPE
        ? bindings.CELL_FIELD_TYPE_HASH
        : bindings.CELL_FIELD_DATA_HASH;
    let current = 0;
    while (true) {
        try {
            const hash = bindings.loadCellByField(current, bindings.SOURCE_CELL_DEP, field);
 ...
 */
export function lookForDepWithDataHash(dataHash) {
